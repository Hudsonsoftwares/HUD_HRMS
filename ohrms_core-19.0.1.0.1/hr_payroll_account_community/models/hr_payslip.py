...
class HrPayslip(models.Model):
    ...
    def action_payslip_done(self):
        ...
        for slip in self:
            ...
            # Intentionally left in draft. Posting is now a separate,
            # deliberate action taken by Accounting from the Journal Entries
            # list, not an automatic side-effect of HR confirming a payslip.
        return res
